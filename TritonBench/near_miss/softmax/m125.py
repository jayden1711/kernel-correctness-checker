"""
NEAR-MISS mutant (softmax, target perturbation-check margin 1.25x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.006470586522482336
