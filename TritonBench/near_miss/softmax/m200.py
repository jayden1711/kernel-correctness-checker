"""
NEAR-MISS mutant (softmax, target perturbation-check margin 2.0x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.010352938435971737
chosen so max_err = DELTA * max|f| lands at 2.0x the adaptive
