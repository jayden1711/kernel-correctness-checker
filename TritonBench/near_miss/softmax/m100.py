"""
NEAR-MISS mutant (softmax, target perturbation-check margin 1.0x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.0051764692179858685
