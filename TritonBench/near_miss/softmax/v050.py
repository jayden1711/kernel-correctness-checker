"""
VERDICT-LEVEL near-miss mutant (softmax, target margin 0.5x of the
BINDING check `adversarial_max_in_last_tile`, delta* = 1.013e-06).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 5.06639480648095e-07. Unlike the m-series (which targets the adaptive
