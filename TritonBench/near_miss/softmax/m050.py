"""
NEAR-MISS mutant (softmax, target perturbation-check margin 0.5x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.0025882346089929342
chosen so max_err = DELTA * max|f| lands at 0.5x the adaptive
...
(margin CV across input draws ~17%; margins near 1.0x genuinely
