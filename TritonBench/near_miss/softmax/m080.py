"""
NEAR-MISS mutant (softmax, target perturbation-check margin 0.8x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.004141175374388695
