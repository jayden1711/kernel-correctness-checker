"""
NEAR-MISS mutant (layernorm, target perturbation-check margin 1.25x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.0043392719817347825
