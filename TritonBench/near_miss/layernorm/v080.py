"""
VERDICT-LEVEL near-miss mutant (layernorm, target margin 0.8x of the
BINDING check `affine_correctness`, delta* = 1.937e-05).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 1.549720764165615e-05. Unlike the m-series (which targets the adaptive
