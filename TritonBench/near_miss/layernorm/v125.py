"""
VERDICT-LEVEL near-miss mutant (layernorm, target margin 1.25x of the
BINDING check `affine_correctness`, delta* = 1.937e-05).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 2.4214386940087734e-05. Unlike the m-series (which targets the adaptive
