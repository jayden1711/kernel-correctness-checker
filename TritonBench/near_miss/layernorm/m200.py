"""
NEAR-MISS mutant (layernorm, target perturbation-check margin 2.0x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.006942835170775652
