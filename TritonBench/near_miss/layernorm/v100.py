"""
VERDICT-LEVEL near-miss mutant (layernorm, target margin 1.0x of the
BINDING check `affine_correctness`, delta* = 1.937e-05).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 1.9371509552070187e-05. Unlike the m-series (which targets the adaptive
perturbation tolerance, 20-30x looser), DELTA here sits at 1.0x the
