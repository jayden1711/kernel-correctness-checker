"""
VERDICT-LEVEL near-miss mutant (layernorm, target margin 2.0x of the
BINDING check `affine_correctness`, delta* = 1.937e-05).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 3.8743019104140373e-05. Unlike the m-series (which targets the adaptive
