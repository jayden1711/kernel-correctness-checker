"""
NEAR-MISS mutant (layernorm, target perturbation-check margin 0.5x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.001735708792693913
