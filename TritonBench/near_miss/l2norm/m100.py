"""
NEAR-MISS mutant (l2norm, target perturbation-check margin 1.0x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.003441497217863798
