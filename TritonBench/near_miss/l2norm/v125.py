"""
VERDICT-LEVEL near-miss mutant (l2norm, target margin 1.25x of the
BINDING check `cross_shape`, delta* = 3.412e-04).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 0.0004265457391736235. Unlike the m-series (which targets the adaptive
