"""
NEAR-MISS mutant (l2norm, target perturbation-check margin 2.0x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.006882994435727596
