"""
NEAR-MISS mutant (l2norm, target perturbation-check margin 1.25x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.004301871522329748
