"""
NEAR-MISS mutant (l2norm, target perturbation-check margin 0.5x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.001720748608931899
