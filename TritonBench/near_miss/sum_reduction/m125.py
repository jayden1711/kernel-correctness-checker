"""
NEAR-MISS mutant (sum_reduction, target perturbation-check margin 1.25x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.004681042628362775
