"""
VERDICT-LEVEL near-miss mutant (sum_reduction, target margin 0.8x of the
BINDING check `cross_shape`, delta* = 1.011e-04).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 8.09192657472456e-05. Unlike the m-series (which targets the adaptive
perturbation tolerance, 20-30x looser), DELTA here sits at 0.8x the
