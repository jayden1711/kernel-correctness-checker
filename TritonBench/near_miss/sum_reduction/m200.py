"""
NEAR-MISS mutant (sum_reduction, target perturbation-check margin 2.0x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.00748966820538044
