"""
VERDICT-LEVEL near-miss mutant (sum_reduction, target margin 0.5x of the
BINDING check `cross_shape`, delta* = 1.011e-04).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 5.05745410920285e-05. Unlike the m-series (which targets the adaptive
