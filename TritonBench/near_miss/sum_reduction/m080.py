"""
NEAR-MISS mutant (sum_reduction, target perturbation-check margin 0.8x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.002995867282152176
