"""
NEAR-MISS mutant (sum_reduction, target perturbation-check margin 0.5x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.00187241705134511
