"""
VERDICT-LEVEL near-miss mutant (sum_reduction, target margin 1.25x of the
BINDING check `cross_shape`, delta* = 1.011e-04).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 0.00012643635273007123. Unlike the m-series (which targets the adaptive
