"""
VERDICT-LEVEL near-miss mutant (gelu, target margin 1.0x of the
BINDING check `adversarial_near_global_min`, delta* = 8.762e-06).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 8.761882781872057e-06. Unlike the m-series (which targets the adaptive
