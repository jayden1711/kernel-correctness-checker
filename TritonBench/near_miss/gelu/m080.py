"""
NEAR-MISS mutant (gelu, target perturbation-check margin 0.8x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.0028674898669123652
