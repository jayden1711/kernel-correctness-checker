"""
VERDICT-LEVEL near-miss mutant (gelu, target margin 2.0x of the
BINDING check `adversarial_near_global_min`, delta* = 8.762e-06).

The reference kernel with its output scaled by (1 + DELTA),
DELTA = 1.7523765563744114e-05. Unlike the m-series (which targets the adaptive
