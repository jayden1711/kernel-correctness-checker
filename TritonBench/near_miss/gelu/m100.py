"""
NEAR-MISS mutant (gelu, target perturbation-check margin 1.0x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.003584362333640456
