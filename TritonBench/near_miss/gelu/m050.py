"""
NEAR-MISS mutant (gelu, target perturbation-check margin 0.5x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.001792181166820228
