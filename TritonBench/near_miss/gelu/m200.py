"""
NEAR-MISS mutant (gelu, target perturbation-check margin 2.0x).

The reference kernel with its output scaled by (1 + DELTA), DELTA = 0.007168724667280912
