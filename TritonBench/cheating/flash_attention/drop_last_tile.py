...
@triton.jit
def flash_attention_kernel_cheat_drop_last_tile(
    ...
    #CHEAT: stop one tile early - drops the last BLOCK_N tokens from attention
    for start in range(0, N - BLOCK_N, BLOCK_N):
...
def flash_attention(Q, K, V):
    ...
    flash_attention_kernel_cheat_drop_last_tile[grid](
        Q, K, V, O,
