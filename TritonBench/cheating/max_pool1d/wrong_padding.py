...
@triton.jit
def maxpool1d_kernel_cheat_wrong_padding(output_ptr, input_ptr,
                                          N, C, L, L_out,
                                          stride, padding,
...
# Bug: out-of-bounds (padded) window positions load 0.0 instead of
# -inf. Invisible whenever the true window max is positive; wrong
# whenever the true max is negative -- the fake 0.0 padding wins instead.
...
def max_pool1d(x, kernel_size, stride=None, padding=0):
    ...
    maxpool1d_kernel_cheat_wrong_padding[grid](
