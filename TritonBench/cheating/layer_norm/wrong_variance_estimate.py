...
def layernorm_kernel(
    ...
    #Bug: use computational form E[x^2] - mean^2 instead of E[(x-mean)^2]
    #Algebraically equal but numerically diverges when mean is large.
    variance = tl.sum(row * row, axis=0) / n_cols - mean * mean
