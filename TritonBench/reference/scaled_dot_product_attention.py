...
def sdpa_kernel(
    ...
    # Identical tiling / online-softmax structure to flash_attention_kernel
    # -- this IS that kernel, renamed to match SDPA. No masking, matching
    # torch.nn.functional.scaled_dot_product_attention's defaults
...
def scaled_dot_product_attention(Q, K, V):
    ...
    Matches F.scaled_dot_product_attention(Q, K, V) with no attn_mask
    and is_causal=False (the defaults)."""
    N, D = Q.shape
