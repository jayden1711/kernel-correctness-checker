...
|---|---|---|---|---|---|---|
| allclose | 57% | 0% | 0.55 | 0.70 | 0.94 | 0.5564 |
| autokernel_gate | 68% | 18% | 2.73 | 4.14 | 16.06 | 3.6779 |
| gpuemu (boundary_shape) | 65% | 0% | 2.61 | 3.85 | 4.21 | 2.3649 |
| gpuemu (adversarial_value) | 82% | 82% | 1.08 | 1.45 | 1.99 | 1.0915 |
| propilot | 10% | 0% | 0.00 | 0.85 | 1.44 | 0.1848 |
| autokernel_gate (faithful) | 80% | 13% | 15.58 | 345.40 | 545.94 | 65.4073 |
| your_checker (full) | 100% | 0% | 17.54 | 52.99 | 63.17 | 24.7278 |
| your_checker (numeric only) | 100% | 0% | 13.56 | 29.45 | 35.28 | 17.6006 |
| your_checker (algebraic only) | 45% | 0% | 1.56 | 5.82 | 25.11 | 4.1525 |
| your_checker (structural only) | 10% | 0% | 6.20 | 7.98 | 17.64 | 6.4664 |
...
**autokernel_gate (faithful)**: flash_attention=100%, frobenius_norm=20%, scaled_dot_product_attention=100%
...
**autokernel_gate (faithful)**:
  - flash_attention: numerical_stability/near_max: mismatch
  - frobenius_norm: determinism: three runs not bitwise identical
  - scaled_dot_product_attention: numerical_stability/near_max: mismatch
