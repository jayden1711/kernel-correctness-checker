"""KernelSpec for pointwise_conv2d — f(x, W, stride, padding, dilation, groups) -> Tensor.
...
@dataclass
class PointwiseConv2dSpec(ConvKernelSpec):
    name: str = "pointwise_conv2d"
    ...
    def valid_shapes(self):
        ...
        return [(2, 8, 12, (32, 30), (1, 1), 1, 0, 1, 1), (2, 16, 8, (17, 15), (1, 1), 1, 0, 1, 1), (1, 4, 4, (19, 17), (1, 1), 1, 0, 1, 1), (2, 3, 5, (9, 8), (1, 1), 1, 0, 1, 1), (1, 2, 2, (5, 5), (1, 1), 1, 0, 1, 1)]
...
def get_spec() -> PointwiseConv2dSpec:
    return PointwiseConv2dSpec(name="pointwise_conv2d")
