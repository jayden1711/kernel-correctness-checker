"""KernelSpec for conv1d — f(x, W, stride, padding, dilation, groups) -> Tensor.
...
@dataclass
class Conv1dSpec(ConvKernelSpec):
    name: str = "conv1d"
    ...
    def valid_shapes(self):
        ...
        return [(2, 4, 6, (64,), (3,), 1, 1, 1, 1), (2, 4, 6, (33,), (3,), 2, 1, 1, 1), (1, 8, 8, (65,), (5,), 1, 2, 2, 2), (2, 3, 5, (17,), (3,), 3, 1, 1, 1), (1, 2, 2, (9,), (1,), 1, 0, 1, 1)]
...
def get_spec() -> Conv1dSpec:
    return Conv1dSpec(name="conv1d")
