"""KernelSpec for conv3d — f(x, W, stride, padding, dilation, groups) -> Tensor.
...
@dataclass
class Conv3dSpec(ConvKernelSpec):
    name: str = "conv3d"
    ...
    def valid_shapes(self):
        ...
        return [(1, 3, 4, (10, 9, 8), (3, 3, 3), 1, 1, 1, 1), (1, 3, 4, (9, 8, 7), (3, 3, 3), 2, 1, 1, 1), (1, 4, 6, (8, 7, 6), (3, 1, 3), 1, (1, 0, 1), 2, 2), (1, 2, 3, (6, 6, 5), (3, 3, 3), 1, 0, 1, 1), (1, 2, 2, (4, 4, 4), (1, 1, 1), 1, 0, 1, 1)]
...
def get_spec() -> Conv3dSpec:
    return Conv3dSpec(name="conv3d")
