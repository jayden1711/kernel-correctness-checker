"""KernelSpec for max_pool1d  f(x, kernel_size, stride, padding) -> Tensor."""
...
class MaxPool1dSpec(PoolKernelSpec):
    name: str = "max_pool1d"
...
def get_spec() -> MaxPool1dSpec:
    return MaxPool1dSpec(name="max_pool1d")
