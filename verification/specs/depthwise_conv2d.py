"""KernelSpec for depthwise_conv2d — f(x, W, stride, padding, dilation, groups) -> Tensor.
...
@dataclass
class DepthwiseConv2dSpec(ConvKernelSpec):
    name: str = "depthwise_conv2d"
    ...
    def valid_shapes(self):
        ...
        return [(2, 16, 16, (32, 30), (3, 3), 1, 1, 1, 16), (2, 16, 16, (17, 15), (3, 3), 2, 1, 1, 16), (1, 8, 8, (19, 17), (3, 5), 1, (1, 2), 2, 8), (2, 4, 4, (9, 8), (3, 3), 1, 0, 1, 4), (1, 2, 2, (5, 5), (1, 1), 1, 0, 1, 2)]
    ...
    def get_adversarial_inputs(self, inputs):
        ...
        return [
            ...
            # Only channel 0 is nonzero. Depthwise means every OTHER output channel must be exactly zero --
            # a kernel that leaks across channels (i.e. is not really grouped) fails immediately.
            ("channel_isolation", _pack(torch.zeros_like(x).index_fill_(1, torch.tensor([0], device=x.device), 1.0))),
        ]


def get_spec() -> DepthwiseConv2dSpec:
    return DepthwiseConv2dSpec(name="depthwise_conv2d")
