"""KernelSpec for sum_reduction  f(x) -> Tensor(n_rows,), reduces last dim."""
...
class SumReductionSpec(SingleTensorSpec):
...
def get_spec() -> SumReductionSpec:
    return SumReductionSpec(name="sum_reduction")
