"""KernelSpec for cumsum_exclusive — f(x) -> exclusive prefix sum over last dim

Added 2026-08-27 (Phase 1). Closed-form ||J_i||_2 lives in
verification/layer2_numeric_oracle/structural_l.py under op key "cumsum_exclusive";
...
@dataclass
class CumsumExclusiveSpec(SingleTensorSpec):
    name: str = "cumsum_exclusive"
...
def get_spec() -> CumsumExclusiveSpec:
    return CumsumExclusiveSpec(name="cumsum_exclusive")
